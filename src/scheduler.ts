...
type Range<START extends number, END extends number, ARR extends unknown[] = [], ACC extends number = never> = ARR["length"] extends END
  ? ACC | START | END
...
export abstract class BaseSchedule {
  ...
  protected hourBasedSchedule(minutes: string | number | Range<0, 59>[], hours: string | number | Range<0, 59>[]) {
